...
def main(args):
    ...
    # remote_server_uri = "http://ec2-.compute.amazonaws.com:5000/"
    # mlflow.set_tracking_uri(remote_server_uri)
    
    mlflow.set_experiment(args.experiment)
    with mlflow.start_run(run_name=run_name): # TODO: add args.run_name argument into mlflow.start_run() e.g. run_name="... Experiment"
        ...
        # Log metrics
        mlflow.log_metric("final_train_loss", float(train_losses[-1]))
        mlflow.log_metric("final_test_loss", float(test_losses[-1]))
        ...
        # Save and log model
        mlflow.pytorch.log_model(model, "trained_lstm")


        #register model # TODO: Test run this
